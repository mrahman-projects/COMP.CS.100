"""
This program prints the song lyrics with a help of function for
repetitive chorus

Project No.Name: 3.5.1_The song "Puff the Magic Dragon"
...
def print_chorus():
    """this function returns the repetitive chorus in the song
    separated by comma"""
